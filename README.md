# 新完全掌握N1语法例句 (Shin Kanzen Master Grammar N1)
...
[![GitHub](https://img.shields.io/badge/GitHub-Repo-181717?style=for-the-badge&logo=github)](https://github.com/mxggle/anki-jlpt-n1-grammar-example-sentences)
...
这是一个基于《新完全掌握日本语能力考试N1级语法》教材的Anki记忆卡牌项目。
...
本项目包含了《新完全掌握N1语法》书中的所有例句，每个句子都配有详细的语法解释、词汇分析和音频发音。适合准备JLPT N1考试的学习者系统地掌握N1语法点。
...
2. 打开Anki
3. 点击“文件” → “导入”
4. 选择`shin-kanzen-n1-grammar/notes.csv`文件
5. 确保`shin-kanzen-n1-grammar/medias/`文件夹中的音频文件在Anki的媒体文件夹中
...
内容基于《新完全掌握日本语能力考试N1级语法》教材，仅供学习交流使用。
